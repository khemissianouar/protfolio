...
<nav class="menu">
      ...
      <a href=""> MES COMPETENCES </a>
      <a href=""> MES PROJETS</a>
    <a href=""> CONTACT</a>

</nav>

<div class="m-mav-toggle">
             ...
             <div class="col-lg-12">
                 <div class="intro-message">
                     ...
                     <ul class="buttons">
                         ...
                         <li>
                             <a href="https://www.freecodecamp.com/thiagoferreira" target="_blank" class="btn btn-default btn-lg"><i class="fa fa-cloud-download" aria-hidden="true"></i> <span class="network-name">freeCodeCamp</span></a>
                         </li>
                     </ul>
                 </div>
             </div>
